...
- Add JSON and TOML output using a command such as --output toml ( <code style="color : green">Minor</code> )
...
- ~~- Separate logo handling functions in a folder, add more distros ( <code style="color : green">Minor</code> )~~
